...
import { addTypingForm } from "../../services/typing.service";
import { HotToaster } from "../../utils/Toaster";
const MathsReasoing = (props) =>{
  ...
  const handleSubmit = async() => {
    ...
    formdata.append("subject",props.tab)
    formdata.append("name",name)
    formdata.append("email",email)
    formdata.append("file",file)
    formdata.append("message",message)
    let result = await addTypingForm(formdata)
    ...
    return(
        ...
        <div className="form-group col-md-6">
          ...
          <input class="form-control" type="text" name="subject" value={props.tab} readonly="readonly" />
        </div>
        <div className="form-group col-md-6">
